...
map = folium.Map(location=[38.36, -99.03], zoom_start=6, tiles="Mapbox Bright")

fgv = folium.FeatureGroup(name="Volcanoes")
for lt, ln, el in zip(lat, lon, elev):
    fgv.add_child(folium.CircleMarker(location=[lt, ln], radius=5, color='grey', popup=str(el)+" m", fill_color=color_producer(el), fill=True, fill_opacity=0.7))
